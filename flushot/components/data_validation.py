...
from flushot.entity.artifact_entity import DataValidationArtifact

from flushot.entity.config_entity import DataValidationConfig
from flushot.constant.training_pipeline import SCHEMA_FILE_PATH

from flushot.utils.main_utils.utils import read_yaml_file, write_yaml_file
...
class DataValidation:
    ...
    def validate_number_of_columns(self, dataframe: pd.DataFrame) -> bool:
        try:
            required_columns = set(self._schema_config["columns"].keys())
            columns_to_ignore = {"is_train"}
            required_columns = required_columns - columns_to_ignore
